...
clientkeys = gears.table.join(
  ...
  awful.key({ mod.super }, "c", function(c) c:kill() end,
    { description = "close", group = "client" }),

  awful.key({ mod.super, "Control" }, "space", awful.client.floating.toggle,
    { description = "toggle floating", group = "client" }),

  awful.key({ mod.super, "Control" }, "Return", function(c) c:swap(awful.client.getmaster()) end,
  ...
  awful.key({ mod.super, "Control" }, "m",
    function(c)
      c.maximized_vertical = not c.maximized_vertical
      c:raise()
    end,
    { description = "(un)maximize vertically", group = "client" }),
  awful.key({ mod.super, "Shift" }, "m",
    function(c)
